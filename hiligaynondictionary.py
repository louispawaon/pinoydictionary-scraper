# Scraping through https://hiligaynon.pinoydictionary.com/list/
...
def main():
    ...
    with open('hiligaynon_wordlist.txt','wt')as f:
        while True:
            try:
                configuredurl = 'http://hiligaynon.pinoydictionary.com/list/' + letters[letter_index] + '/' + str(page_index) + '/'
